...
The parameters may not fit nicely onto the same line as the `(`, but they do
fit if you put them on their own line; if that's true, put them on their own
line, indented once, and put a comma after the last parameter.
